...
int main ( void )
{
    ...
    }
    {
        ...
        ac::DAL<int, std::string> dic2(100);
        EXPECT_EQUAL( tm, test_id,   dic2.capacity(), 100 );
    }

    {
        // Testing insert.
        ac::DAL<int, std::string, MyKeyComparator> dict(3);
...

    {
        ...
        ac::DSAL<int, std::string> dic2(100);
        EXPECT_EQUAL( tm2, test_id,   dic2.capacity(), 100 );
    }

    {
        // Testing insert.
        ac::DSAL<int, std::string, MyKeyComparator> dict(3);
        auto test_id{ "InsertRegular" };
